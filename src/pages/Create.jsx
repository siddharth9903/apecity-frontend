...
const Create = () => {
    ...
    //         const args = [values.name, values.symbol, values.tokenURI];
    ...
    //             value = values?.buyAmountEth
    //         } else {
    //             const estimateEthIn = new BigNumber(estimateEthInForExactTokensOut(initialConstants.circulatingSupply, initialConstants.poolBalance, initialConstants.reserveRatio, values?.buyAmountToken || '0')).toString();
    //             value = estimateEthIn
    //         }
    ...
    //         const args = [values.name, values.symbol, tokenURI]
    //         const valueToSend = adjustedInputAmount.toFixed();
