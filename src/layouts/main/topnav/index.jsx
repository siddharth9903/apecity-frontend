                                            ...
                                            <button onClick={onCloseModal} className="bg-transparent rounded p-1 border border-[#ffffff29]">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex flex-col mt-4 gap-y-3">
                                                        ...
                                                        <p className="text-gray-300 max-sm:text-sm pfont-400 text-center tracking-[0.5px]"><span className="text-white">Step 4 :</span> Once your token reaches a market cap of 8.4 ETH, a liquidity pool is automatically created on Uniswap.</p>
