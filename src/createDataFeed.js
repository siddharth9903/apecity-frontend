...
function createDataFeed(_symbol, _tokenAddress, _bondingCurveAddress) {
    ...
    const modifiedDataFeed = {
        ...
        //                 currentBar.open = tradeOpenPrice;
        //                 currentBar.high = tradeType === 'BUY' ? tradeClosePrice : tradeOpenPrice;
        //                 currentBar.low = tradeType === 'BUY' ? tradeOpenPrice : tradeClosePrice;
        //                 currentBar.close = tradeClosePrice;
        //             } else {
        //                 // Update the current bar
        //                 currentBar.high = Math.max(currentBar.high, tradeType === 'BUY' ? tradeClosePrice : tradeOpenPrice);
        //                 currentBar.low = Math.min(currentBar.low, tradeType === 'BUY' ? tradeOpenPrice : tradeClosePrice);
        //                 currentBar.close = tradeClosePrice;
        ...
        //                         time: tradeTime,
        //                         open: tradeOpenPrice,
        //                         high: tradeType === 'BUY' ? tradeClosePrice : tradeOpenPrice,
        //                         low: tradeType === 'BUY' ? tradeOpenPrice : tradeClosePrice,
        //                         close: tradeClosePrice,
        //                     };
        //                 }
        //             }
        //         }
